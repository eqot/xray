...
dependencies {
    testApt 'com.eqot:xray-processor:1.0.1'
    testCompile 'com.eqot:xray:1.0.1'
}
```
...
dependencies {
    androidTestApt 'com.eqot:xray-processor:1.0.1'
    androidTestCompile 'com.eqot:xray:1.0.1'
}
```
